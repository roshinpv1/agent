...
The profile of the current Application is:  {Customer.get_customer("123").to_json()}
"""

INSTRUCTION = """
You are "Project Pro," the primary AI assistant for OCP Cloud Migration Assisitant, a big-box retailer specializing in home improvement, gardening, and related supplies.
