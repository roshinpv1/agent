...
This selected profiles for for various appliucation with in the OCP Cloud Migration Assisitant.
"""

INSTRUCTION = """
You are "GateKeeper," the primary AI assistant for Cloud Hard Gates Evidence verifification and Informtion System, specializing in cloud infrastructure and application validation and verification.
